...
class OtherPrefs(Frame):
    def __init__(self, master):
        ...
        slider1 = Scale(self, from_=0, to=20, orient=HORIZONTAL, length=300, variable=sliderVar)
        slider1.set(8)
...
class ShowSched(Frame):
    def __init__(self, master):
        ...
        label6 = Label(self, text="Fall", font=("Helvetica", 8, "underline"))
        label6.grid(row=8, rowspan=1, column=0, columnspan=1, sticky=W)

        label7 = Label(self, text="Winter", font=("Helvetica", 8, "underline"))
        label7.grid(row=8, rowspan=1, column=2, columnspan=1, sticky=W)

        label8 = Label(self, text="Spring", font=("Helvetica", 8, "underline"))
        label8.grid(row=8, rowspan=1, column=4, columnspan=1, sticky=W)

        label9 = Label(self, text="Summer", font=("Helvetica", 8, "underline"))
        label9.grid(row=8, rowspan=1, column=6, columnspan=1, sticky=W)
                ...
                for course in major_curriculum:
                    ...
                    if len(taken_classes) > 0:
                        for j in taken_classes:
                            if test.preReq != None:
                                if (j in test.preReq and j not in list and hours+test.hrs <= self.master.num_hours) or (j in test.preReq and j not in list and i > 10 and hours < self.master.num_hours):
                                    print "first if"
                                    list.append(course)
                                    ...
                                    hours += test.hrs
                                    break
                            elif (test.preReq == None and course not in list and hours+test.hrs <= self.master.num_hours) or (test.preReq == None and test not in list and i > 10 and hours < self.master.num_hours):
                                print "second if"
                                list.append(course)
                                taken_classes.append(course)
                                major_curriculum.remove(course)
